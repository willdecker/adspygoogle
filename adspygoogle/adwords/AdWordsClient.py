  ...
  def __init__(self, headers=None, config=None, path=None,
    ...
    if path is not None:
      ...
      if os.path.isabs(path):
        ...
        AdWordsClient.home = os.path.normpath(os.path.join(os.getcwd(), path))

      # If pickles don't exist at given location, default to current working director.
